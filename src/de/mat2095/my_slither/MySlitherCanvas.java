...
final class MySlitherCanvas extends JPanel {
    ...
    public class MouseInput extends Player {
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        synchronized (view.modelLock) {
            ...
            model.snakes.values().forEach(snake -> {
                ...
                g.drawString(lengthText, (float) (snake.x - g.getFontMetrics().stringWidth(lengthText) / 2.0 + g.getFontMetrics().getHeight() / 12.0), (float) (snake.y - thickness * 2 / 3 + g.getFontMetrics().getHeight() / 12.0));
        ...
        g.drawString(String.format(Locale.ROOT, "FPS: %04.1f", 1000.0 / (newFrameTime - lastFrameTime)), 0, g.getFontMetrics().getAscent());
